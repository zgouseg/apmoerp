...
=========================================
This view uses {!! $qrCodeSvg !!} to render a QR code image. This is safe because:
            ...
            <div class="text-center">
                <div class="mb-6">
                    ...
                    <div class="flex justify-center mb-4">
                        {{-- SECURITY: $qrCodeSvg is generated by PragmaRX Google2FA library --}}
                        {{-- It is not user input - it's a QR code SVG generated server-side --}}
                        {!! $qrCodeSvg !!}
                    </div>
