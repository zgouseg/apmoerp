{{--
SECURITY (V37-XSS-06): QR Code SVG Safety
=========================================
This view uses unescaped Blade output to render a QR code image. This is safe because:
1. $qrCodeSvg is generated server-side by the PragmaRX Google2FA library
2. It is NOT user input - it's a trusted library-generated SVG
3. The QR code encodes the TOTP secret for authenticator apps

Static analysis tools may flag unescaped output as XSS risks. This is a false positive
when the content is generated by trusted server-side libraries.
--}}
            ...
            <div class="text-center">
                <div class="mb-6">
                    ...
                    <div class="flex justify-center mb-4">
                        {{-- SECURITY (V45-XSS-01): QR code SVG is sanitized using sanitize_svg_icon() --}}
                        {{-- Even though $qrCodeSvg is generated by PragmaRX Google2FA library, we apply --}}
                        {{-- sanitization as a defense-in-depth measure for hardening --}}
                        {!! sanitize_svg_icon($qrCodeSvg) !!}
                    </div>
