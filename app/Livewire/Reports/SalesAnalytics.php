 ...
 *
 * SECURITY (V40-SQL-05): SQL Expression Safety - REVIEWED
 * ========================================================
 ...
 *    (monthTruncateExpression, weekTruncateExpression, dateExpression)
 *    - Validates column names via regex pattern
 *    - Returns hardcoded SQL expressions for each database driver
 *
 * 2. $hourExpr: Generated by DatabaseCompatibilityService::hourExpression()
 *    - Only accepts validated column names
 *    - Called with hardcoded 'created_at' column
 *
 * 3. Column names (sale_date, created_at, total_amount) are hardcoded in codebase
 *
...
class SalesAnalytics extends Component
{
    ...
    protected function loadSalesTrend(): void
    {
        ...
        // @security-reviewed V43 - $dateFormat is validated by DatabaseCompatibilityService regex patterns
        ...
        // V35-MED-06 FIX: Exclude non-revenue statuses
        // @phpstan-ignore-next-line - $dateFormat is regex-validated by DatabaseCompatibilityService
        $query = Sale::query()
     ...
     * which returns hardcoded SQL expressions based on the database driver.
     * No user input is interpolated into the SQL.
     * @security-reviewed V43 - $hourExpr is validated by DatabaseCompatibilityService
     */
    protected function loadHourlyDistribution(): void
    {
        // @phpstan-ignore-next-line - Expression is regex-validated by DatabaseCompatibilityService
