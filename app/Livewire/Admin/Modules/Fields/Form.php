...
class Form extends Component
{
    ...
    {
        // Only auto-generate if not editing an existing field and field_key is empty or was auto-generated
        if (! $this->fieldId && (empty($this->field_key) || $this->wasKeyAutoGenerated())) {
            $this->field_key = $this->generateFieldKey($this->field_label);
        }
    }

    protected function wasKeyAutoGenerated(): bool
    {
        // Check if current key matches what would be auto-generated from label
        return $this->field_key === $this->generateFieldKey($this->field_label);
    }
