 ...
 * Product Model
 *
 * SECURITY (V40-SQL-06): SQL Expression Safety in Query Scopes - REVIEWED
 * =========================================================================
 * This model uses whereRaw() in query scopes (scopeLowStock, scopeOutOfStock, scopeInStock)
 * with variable interpolation. All interpolated values are SAFE because they come from
 * validated sources:
 *
 ...
 *
 * 2. Column references ('products.id', 'products.branch_id') are hardcoded in this file
 *
 * 3. Comparison columns (stock_alert_threshold, reorder_point) are hardcoded schema names
 *
