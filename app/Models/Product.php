 ...
 * Product Model
 *
 * SECURITY (V37-SQL-06): SQL Expression Safety in Query Scopes
 * =============================================================
 * This model uses whereRaw() in query scopes (scopeLowStock, scopeOutOfStock, scopeInStock)
 * with variable interpolation. All interpolated values are safe because:
 *
 * 1. $stockSubquery variable: Generated by StockService::getBranchStockCalculationExpression()
 *    which validates all column names using regex patterns. See StockService class
 *    documentation for validation details.
 *
 * 2. Column references passed to StockService: Always hardcoded strings
 *    ('products.id', 'products.branch_id') defined in this file, never user input.
 *
 * 3. Comparison columns (stock_alert_threshold, reorder_point): Hardcoded column names
 *    from the products table schema.
 *
