 ...
 *
 * SECURITY (V37-SQL-08): SQL Expression Safety
 * =============================================
 ...
 *    which return hardcoded SQL expressions based on the database driver.
 *
 * 2. All other raw SQL uses only hardcoded column names from the database schema.
 *
 * 3. Parameters like $productId, $branchId are passed through where() with proper binding.
 *
