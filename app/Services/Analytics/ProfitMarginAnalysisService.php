 ...
 *
 * SECURITY (V40-SQL-07): SQL Expression Safety - REVIEWED
 * ========================================================
 ...
 *
 * 1. $periodExpr: Generated by DatabaseCompatibilityService methods
 *    - Validates column names via regex pattern
 *    - Returns hardcoded SQL expressions for each database driver
 *
 * 2. Column names (sale_items.*, products.*, etc.) are hardcoded in codebase
 *
 * 3. Parameters ($branchId) use proper binding via where() clauses
 *
...
class ProfitMarginAnalysisService
{
     ...
     * The $groupBy parameter is validated against a whitelist to ensure safety.
    ...
    {
        // V37-SEC: Validate groupBy against whitelist to prevent SQL injection
