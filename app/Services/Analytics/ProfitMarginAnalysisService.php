 ...
 *
 * SECURITY (V37-SQL-07): SQL Expression Safety
 * =============================================
 * This service uses selectRaw() and groupBy() with variable interpolation.
 * All interpolated values are safe because:
 *
 * 1. $periodExpr: Generated by DatabaseCompatibilityService methods which return
 ...
 *
 * 3. Parameters like $branchId are passed through where() with proper binding.
 *
