...
/**
 * ScheduledReportService - Generate and send scheduled reports
 *
 * SECURITY (V40-SQL-11): SQL Expression Safety - REVIEWED
 * ========================================================
 * This service uses selectRaw(), groupBy(), and whereRaw() with variable interpolation.
 * All interpolated values are SAFE because they come from validated sources:
 *
 * 1. $dateExpr: Generated by DatabaseCompatibilityService::dateExpression()
 *    - Validates column names via regex pattern
 *    - Returns hardcoded SQL expressions for each database driver
 *
 * 2. $stockSubquery: Generated by StockService::getBranchStockCalculationExpression()
 *    - Validates column names via regex pattern
 *    - Validates branch ID as positive integer
 *
 * 3. Filter parameters (date_from, date_to, branch_id) use proper binding via where()
 *
 * @security-reviewed V40 - SQL expressions validated via DatabaseCompatibilityService/StockService
 */
class ScheduledReportService
{
    ...
    protected function fetchSalesReportData(array $filters): array
    {
        try {
            ...
            // SECURITY: $dateExpr is generated by DatabaseCompatibilityService which returns
            // hardcoded SQL expressions based on database driver - no user input interpolation
    ...
    protected function fetchInventoryReportData(array $filters): array
    {
        try {
            ...
            if (! empty($filters['low_stock'])) {
                ...
                // SECURITY: $stockSubquery is generated by StockService which validates column names
                // with strict regex patterns - no user input flows into the SQL expression
