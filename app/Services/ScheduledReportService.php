 ...
 *
 * SECURITY (V37-SQL-11): SQL Expression Safety
 * =============================================
 ...
 *
 * 3. All other raw SQL uses only hardcoded column names from the database schema.
 *
 * 4. Filter parameters (date_from, date_to, branch_id, category_id) are passed through
 *    proper binding via where() clauses with type casting.
 *
