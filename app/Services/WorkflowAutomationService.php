 ...
 *
 * SECURITY (V40-SQL-14): SQL Expression Safety - REVIEWED
 * ========================================================
 ...
 *
 * 2. Column names passed to StockService: Hardcoded strings ('products.id', 'products.branch_id')
 *
 * 3. Comparison columns (reorder_point, min_stock): Hardcoded column names from schema
 *
