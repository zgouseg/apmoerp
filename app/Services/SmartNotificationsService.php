 ...
 * - System alerts
 *
 * SECURITY (V40-SQL-12): SQL Expression Safety - REVIEWED
 * ========================================================
 * This service uses selectRaw() and whereRaw() with variable interpolation.
 ...
 *
 * 2. Column names ('products.id', 'products.min_stock') are hardcoded
 *
...
class SmartNotificationsService
{
     ...
     *
     * SECURITY NOTE: The $stockExpr variable is generated by StockService methods
     * which only accept hardcoded column names validated against SQL injection patterns.
