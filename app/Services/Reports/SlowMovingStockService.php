...
/**
 * SlowMovingStockService - Identify slow-moving and obsolete inventory
 *
 * SECURITY (V40-SQL-10): SQL Expression Safety - REVIEWED
 * ========================================================
 * This service uses selectRaw() with variable interpolation for $daysDiffExpr.
 * All interpolated values are SAFE because they come from validated sources:
 *
 * 1. $daysDiffExpr: Generated by DatabaseCompatibilityService::daysDifference()
 *    - Validates all parameters via regex and whitelist
 *    - Returns hardcoded SQL expressions for each database driver
 *
 * 2. Column names ('MAX(sale_items.created_at)') are hardcoded in this file
 *
 * 3. The $days parameter uses proper binding via havingRaw() with (?)
 *
...
class SlowMovingStockService
{
     ...
     *
     * SECURITY NOTE: The $daysDiffExpr is generated by DatabaseCompatibilityService::daysDifference()
