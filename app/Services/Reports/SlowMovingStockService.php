 ...
 *
 * SECURITY (V37-SQL-10): SQL Expression Safety
 * =============================================
 ...
 *
 * 2. Column names passed to daysDifference() are hardcoded strings
 *    ('MAX(sale_items.created_at)') from this file, never user input.
 *
 * 3. The $days parameter is passed through havingRaw() with proper binding (?).
 *
