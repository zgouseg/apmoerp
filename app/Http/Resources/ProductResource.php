...
class ProductResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'price' => decimal_float($this->default_price),
            'cost' => $this->when(self::$canViewCost, decimal_float($this->cost)),
            // Inventory fields
            'min_stock' => $this->min_stock ? decimal_float($this->min_stock) : 0.0,
            'max_stock' => $this->max_stock ? decimal_float($this->max_stock) : null,
            'reorder_point' => $this->reorder_point ? decimal_float($this->reorder_point) : 0.0,
            'reorder_qty' => $this->reorder_qty ? decimal_float($this->reorder_qty) : 0.0,
