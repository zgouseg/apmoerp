            ...
            'items' => [
                [
                    ...
                    'children' => [
                        ...
                        ['route' => 'app.hrm.payroll.index', 'label' => __('Payroll'), 'permission' => 'hrm.payroll.view'],
                ...
                [
                    'route' => 'app.hrm.my-attendance',
                    'label' => __('Self Service'),
                    'permission' => 'employee.self.attendance',
                    'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',
                    'children' => [
                        ['route' => 'app.hrm.my-attendance', 'label' => __('My Attendance'), 'permission' => 'employee.self.attendance'],
                        ['route' => 'app.hrm.my-leaves', 'label' => __('My Leave Requests'), 'permission' => 'employee.self.leave-request'],
                        ['route' => 'app.hrm.my-payslips', 'label' => __('My Payslips'), 'permission' => 'employee.self.payslip-view'],
                    ],
                ],
            ],
        ],
...
<aside 
    ...
    x-data="{
        ...
        allMenuItems: <?php echo \Illuminate\Support\Js::from(collect($filteredSections)->flatMap(function($section) use ($currentRoute) {
        ...
        init() {
            ...
            <?php $__currentLoopData = $filteredSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionIndex => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemIndex => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($isActive($item['route']) || collect($item['children'] ?? [])->contains(fn($c) => $isActive($c['route']))): ?>
                        this.expandedSections['<?php echo e($section['key']); ?>_<?php echo e($itemIndex); ?>'] = true;
                    <?php endif; ?>
    ...
    <div class="erp-sidebar-header">
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3">
            <span class="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 text-white font-bold text-lg shadow-lg shadow-emerald-500/30">
                <?php echo e(strtoupper(mb_substr(config('app.name', 'G'), 0, 1))); ?>

            </span>
            <div class="flex flex-col min-w-0">
                <span class="text-sm font-semibold truncate text-white"><?php echo e($user->name ?? __('User')); ?></span>
                <span class="text-xs text-emerald-300 truncate"><?php echo e($user?->roles?->first()?->name ?? __('User')); ?></span>
            </div>
        </a>
        ...
        <button 
            ...
            aria-label="<?php echo e(__('Close sidebar')); ?>"
        >
...
[$__name, $__params] = $__split('shared.branch-switcher');

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-267295720-0', $key);
...
?>
    ...
    <div class="erp-sidebar-nav" x-show="isSearching()" x-cloak>
        <div class="erp-sidebar-section">
            <div class="px-3 py-2">
                <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider"><?php echo e(__('Search Results')); ?></span>
            </div>
            <div class="erp-sidebar-items">
                <template x-if="searchResults.length === 0">
                    <div class="px-3 py-2 text-sm text-slate-500"><?php echo e(__('No results found')); ?></div>
                </template>
    ...
    <nav class="erp-sidebar-nav" x-show="!isSearching()" data-sidebar-main-nav>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($filteredSections)): ?>
            ...
            <div class="erp-sidebar-section">
                <div class="px-3 py-4">
                    <div class="flex flex-col items-center text-center gap-3 py-8">
                        ...
                        <p class="text-sm text-slate-400"><?php echo e(__('No modules available.')); ?></p>
                        <p class="text-xs text-slate-500"><?php echo e(__('Please contact your administrator if you believe this is an error.')); ?></p>
                    </div>
                </div>
                ...
                <div class="erp-sidebar-items border-t border-slate-700/50 pt-3 mt-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('profile.edit')): ?>
                    <a 
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filteredSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionIndex => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="erp-sidebar-section">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemIndex => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasChildren): ?>
                            ...
                            <div>
                                <button 
                                    type="button"
                                    @click="toggle('<?php echo e($itemKey); ?>')"
                                    class="erp-sidebar-item w-full <?php echo e($hasActiveChild ? 'active' : ''); ?>"
                                    :aria-expanded="isExpanded('<?php echo e($itemKey); ?>')"
                                >
                                    <span class="erp-sidebar-item-icon">
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                    ...
                                    <span class="flex-1 text-start"><?php echo e($item['label']); ?></span>
                                    <svg 
                                        class="w-4 h-4 transition-transform duration-200"
                                        :class="isExpanded('<?php echo e($itemKey); ?>') ? 'rotate-180' : ''"
                                        fill="none" 
                                        stroke="currentColor" 
                                        viewBox="0 0 24 24"
                                    >
                                ...
                                <div 
                                    x-show="isExpanded('<?php echo e($itemKey); ?>')"
                                ...
                                >
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $item['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <a 
                                            href="<?php echo e($safeRoute($child['route'])); ?>"
                                            @click="sidebarOpen = false"
                                            class="erp-sidebar-subitem <?php echo e($isActive($child['route']) ? 'active' : ''); ?>"
                                        >
                        ...
                        <?php else: ?>
                            ...
                            <a 
                                href="<?php echo e($getItemRoute($item)); ?>"
                                @click="sidebarOpen = false"
                                class="erp-sidebar-item <?php echo e($itemIsActive ? 'active' : ''); ?>"
                            >
                                <span class="erp-sidebar-item-icon">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($item['icon']); ?>"/>
    ...
    <div class="erp-sidebar-footer">
        <div class="flex items-center justify-between text-xs text-slate-500">
            <span class="flex items-center gap-2">
                ...
                <?php echo e(__('Developed By Hugous')); ?>

            </span>
        </div>
    </div>
</aside>
<?php /**PATH /home/runner/work/apmoerp/apmoerp/resources/views/layouts/sidebar-new.blade.php ENDPATH**/ ?>