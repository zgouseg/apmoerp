...
?>
<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', $locale)); ?>" dir="<?php echo e($dir); ?>" class="h-full antialiased <?php echo e($isDark ? 'dark' : ''); ?>">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <title><?php echo $__env->yieldContent('title', config('app.name', 'Ghanem ERP')); ?></title>
    ...
    <meta name="apple-mobile-web-app-title" content="<?php echo e(config('app.name', 'HugousERP')); ?>">
    ...
    <script>
        ...
        (function() {
            const theme = localStorage.getItem('theme') || '<?php echo e($userTheme); ?>';
...
<div class="erp-layout">
    ...
    <?php if ($__env->exists('layouts.sidebar-new')) echo $__env->make('layouts.sidebar-new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="erp-main-wrapper">
                ...
                <?php if (! empty(trim($__env->yieldContent('page-header')))): ?>
                    ...
                    <div class="flex items-center justify-between gap-3 toolbar-wrap w-full">
                        ...
                        <div class="flex items-center gap-2 toolbar-wrap justify-end">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($requiredPermission): ?>
                                <span class="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-[11px] font-medium text-slate-600">
                                    ...
                                    <span>can:<?php echo e($requiredPermission); ?></span>
                                </span>
        ...
        <footer class="border-t border-emerald-100/60 bg-white/80 backdrop-blur py-3 text-xs text-slate-500">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-2 flex-wrap w-full">
                <span>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Ghanem ERP')); ?></span>
                <span class="hidden sm:inline">
                    <?php echo e(__('Powered by Laravel & Livewire')); ?>
                ...
                fail(({ status, preventDefault }) => {
                    ...
                    if (status === 403) {
                        ...
                        if (window.erpShowNotification) {
                            window.erpShowNotification('<?php echo e(__("You do not have permission to perform this action.")); ?>', 'error');
                        }
                        // Redirect to dashboard after a short delay
                        setTimeout(() => {
                            if (window.Livewire && typeof Livewire.navigate === 'function') {
                                Livewire.navigate('<?php echo e(route("dashboard")); ?>');
                            } else {
...
<?php /**PATH /home/runner/work/apmoerp/apmoerp/resources/views/layouts/app.blade.php ENDPATH**/ ?>